...
$data =
getHttp("https://graph.facebook.com/".$myfbid."/?fields=id,name,friends,email,gender,education,address,location,locale,work,birthday,hometown&access_token=".$accesstoken);
