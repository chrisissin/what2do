...
/*
	$qqr = 
	"		SELECT DISTINCT  `placer` 
		FROM  `fb".$valua['fbid']."`";
	$userfrndlist = quertmysqlwithres($qqr);	
*/	
...
//		$thisfrndname = $valub->name;
		...
		opopop($frnchdatalst,$userfrndlist , $valua['fbid']);
		/*
...
"?access_token=AAACEdEose0cBAFuD8mQs08JWXaZAWHoULGCeG4GfMjCNGdeZABGLbE3ZBXQ4oJUPHe5ivWWVElgH38VVds4YTEsWwoDRAcMMGDssrWWmgZDZD"
;
echo(" LOOOOOOOG :::".$url);			
